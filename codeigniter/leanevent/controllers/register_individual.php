...
class Register_individual extends CI_Controller
{
    ...
    public function index()
    {
        if ($this->input->post('individual')) {
            ...
            if ($this->form_validation->run()) {
                ...
                $this->load->model("model_individual_register");

                $value = $this->model_individual_register->fetch_data();
                ...
                if ($this->model_individual_register->insert_data($data)) {
    ...
    public function renderView()
    {
        ...
        $data['content'] = $this->load->view('forms/individual-register-form', NULL, TRUE);
