    ...
    <div class="position-center">
        ...
        <div class="update-profile">
            ...
            <div class="update-profile-form">
                <?php echo form_open_multipart('individual_userprofile/update') ?>
                    ...
                    <div class="column2x">
                        ...
                        <div class="row">
                            <div class="lastName column2x">
                                <?php
                                echo form_label('*Appelidos');
                                echo form_input(['name' => 'surname', 'class' => 'field', 'placeholder' => 'Tu Appelido', 'value' => $lastName, 'disabled' => 'disabled']);
                                ?>
