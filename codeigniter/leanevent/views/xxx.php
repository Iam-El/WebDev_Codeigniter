<div class="mainpage individual-user-profile">
    ...
    <div class="position-center">
        <div class="profile-details">
            ...
            <div class="row">
                <div class="column3x">
                    ...
                    <div class="item">
                        <div class="individual-profile"><span class="fas fa-user fa-1x"></span>
                ...
                <div class="column3x">
                    ...
                    <div class="item">
                        <div class="individual-profile"><span
                                    class="fas fa-map-marker fa-1x"></span> <?php echo $address ?>
                        </div>
                    </div>
                    <div class="item">
                        <div class="individual-profile"><span
                ...
                <div class="column3x">
                    <div class="business-user-image"
                         style="background-image: url('<?php echo $userImage ? $userImage : base_url('assets/image/nologo.png'); ?>');"></div>
                </div>
            </div>
        </div>
        <div class="update-profile">
            ...
            <div class="update-profile-form">
                <?php echo form_open('agent_user_profile/update') ?>
                ...
                <div class="row">
                    <div class="phone column3x full-width">
