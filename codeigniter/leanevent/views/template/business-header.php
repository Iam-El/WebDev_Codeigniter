...
<header>
    <div class="header-content">
        ...
        <div class="menu">
            <nav class="nav-bar">
                <ul>
                    <li class="link active"><a href="<?php echo base_url('business_user_homepage')?>">Inicio</a></li>
                    <li class="link"><a href="<?php  echo base_url('business_user_profile')?>">Foundacion</a></li>
                </ul>
            </nav>
        </div>
    </div>
