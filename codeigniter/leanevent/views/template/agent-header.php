...
<header>
    ...
    <div class="header-content">
        ...
        <div class="menu">
            <nav class="nav-bar">
                <ul>
                    <li class="link active"><a href="<?php echo base_url('agent_homepage') ?>">Inicio</a></li>
                    <li class="link"><a href="<?php echo base_url('agent_list_volunteers') ?>">Lista de Voluntarios</a></li>
                    <li class="link"><a href="<?php echo base_url('agent_list_business') ?>">Lista de Fundaciones</a></li>
                    <li class="link"><a href="<?php echo base_url('agent_list_events') ?>">Eventos</a></li>
                    <li class="link"><a href="<?php echo base_url('agent_userprofile') ?>">Agente</a></li>
                </ul>
            </nav>
        </div>
    </div>
